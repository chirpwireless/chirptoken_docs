...
Congratulations on becoming a Keeper and joining Chirp’s Decentralized Physical Infrastructure Network. By deploying your Blackbird gateway, you are now part of a rapidly growing global network that spans 42 countries and contributes to a service that could be used by millions of people worldwide.

As a Keeper, you play a critical role in expanding wireless coverage and supporting IoT connectivity and decentralized geolocation. Your Blackbird gateway helps power smart automation, location-based services, and real-world asset applications, enabling individuals, businesses, and developers to build on Chirp’s infrastructure without reliance on centralized networks.

Every day, Chirp’s network grows stronger thanks to Keepers like you. By maintaining your Blackbird, you will earn CHIRP tokens based on network demand, uptime, and contribution quality. Your gateway is more than just hardware—it’s a key building block of a decentralized, community-driven future.

If you haven’t purchased a Blackbird gateway yet but want to participate, gateways are sold through Skyward Soarer NFTs. These NFTs can be bought on [tradeport.xyz](https://tradeport.xyz), and after purchase, the NFT must be redeemed to receive your Blackbird device.

We’re excited to have you on board. Now, let’s get your Blackbird installed and registered so you can start contributing to the future of IoT connectivity.
...
## How to Purchase a Blackbird Miner

All Blackbird miners are sold through Skyward Soarer NFTs for $890 USDC. This NFT-based system is essential for securing the network, preventing the kind of spoofed gateways that have harmed other DePIN projects. Spoofed gateways are fake, software-emulated nodes that register on a network without actually providing coverage, existing solely to steal rewards from honest participants.

Chirp solves this problem by requiring every Blackbird miner to be linked to an NFT, proving proof of ownership before it can be activated. This ensures that every registered miner corresponds to a real, physical device that contributes to the network.

**Steps to Purchase a Blackbird Miner**

1. Buy a Skyward Soarer NFT

* Blackbird miners are sold as Skyward Soarer NFTs on  [https://www.tradeport.xyz/sui/collection/skyward-soarer?bottomTab=trades\&tab=items](https://www.tradeport.xyz/sui/collection/skyward-soarer?bottomTab=trades\&tab=items).
* The official price is $890 USDC. Any NFTs listed at a higher price are from resellers.

2. Redeem Your NFT

* After purchasing the NFT, you must redeem it to claim your Blackbird device.
* When your miner is redeemed, your order goes directly to the factory.
* This guarantees that only real miners exist on the network, preventing fraudulent participation.

3. Shipment & Delivery

* Chirp has nothing to do with the shipment process and has no influence on the speed of delivery.
* Once your NFT is redeemed, your order is processed at the factory and shipped directly to you.
* After receiving your Blackbird, you can proceed with installation and registration to start earning CHIRP tokens.

### Why Blackbirds Are Sold Through NFTs

Many DePIN networks have suffered from spoofed gateways, where fraudulent participants emulate physical hardware to steal rewards without providing real network coverage. Chirp prevents this problem by linking each Blackbird miner to an NFT, ensuring that every registered device is physically real and properly distributed.
